$(document).ready(function(){
	...
	$('#concurso1').css({width: $(window).width()*.95, height: $(window).height()*.78, display: 'none'});
	$('#concurso2').css({width: $(window).width()*.95, height: $(window).height()*.78, display: 'none'});
	$('#vota').css({width: $(window).width()*.95, height: $(window).height()*.78, display: 'none'});
	$('#bases').css({width: $(window).width()*.95, height: $(window).height()*.78, display: 'none'});
	$('#videos').css({width: $(window).width()*.95, height: $(window).height()*.78, display: 'none'});
	$('#politicas').css({width: $(window).width()*.95, height: $(window).height()*.78, display: 'none'});
