    ...
    <body prefix="og: http://ogp.me/ns#">
        ...
        <div class="nav bar">
            ...
            <ul>
                ...
                <li><a class="concurso-box" href="#vota">SELFIES</a></li>
        ...
        <!--div id="blanquear" class="container Blusas" data-_sparkles-200p="transform:translate(0,100%);" data-_sparkles-300p="transform:translate(0,0%);" data-_sparkles-400p="transform:translate(0,-100%);">
            ...
            <img data-_sparkles-280p="transform:translate(-100%,0);opacity:0" data-_sparkles-300p="transform:translate(0%,0);opacity:1" class="girl4" src="./img/girl4.png">
            <div class="text">
                <h1 class="decide color" data-_sparkles-280p="opacity:0" data-_sparkles-300p="opacity:1">DECIDIR NO ES<br> <span class="decide">INSTANTÁNEO,<br> BLANQUEAR<br></span>TU SONRISA SÍ.</h1>
                <img data-_sparkles-220p="transform:translate(0,-180%)" data-_sparkles-300p="transform:translate(0,0%)" data-_sparkles-350p="transform:translate(0,50%)" data-_sparkles-400p="transform:translate(0,100%)" src="./img/pasta.png" class="pasta4">
                <p class="leyenda">El efecto blanqueador instantáneo es temporal. Consulta regularmente a tu odontólogo. SSA:143300202d0281</p-->
                <!--a class="boton-down bot" href="#articulos" data-menu-top="700p"><img src="./img/boton-flecha-abajo.png"></a>
            </div>
        </div-->    
        ...
        <div id="magazine" class="container Magazine" data-_sparkles-400p="transform:translate(0,100%);" data-_sparkles-500p="transform:translate(0,0%);">
            <div class="contenido-pag">
                <div class="row">
                    ...
                    <div class="small-6 columns" style="width: 600px;">
        ...
        <div class="paso1-style">
            <h1 class="title-con">CONCURSO #LUMINOUSSELFIE</h1>
            <p class="concursoText compra">Compra Luminous White Instant<br>y registra tu Ticket de compra para participar</p>
            <input type="text" name="" placeholder="captura tu No. de ticket" required class="input ticket">
           <p class="concursoText compra">O</p>
            <input type="text" name="Nombre" placeholder="NOMBRE Y APELLIDO" required class="input nombre"><br />
            <input type="tel" name="tel" placeholder="TELÉFONO" required class="input tel"><br />
            <input type="email" name="Correo" checked="true" placeholder="MAIL" required class="input correo">
            <a href="" class="btn registrate">REGÍSTRATE</a>
            <img src="./img/face_connect.png" class="connect">
            <p class="concursoText fiesta">Las 100 personas con más votos podrían asistir a la Gran Fiesta White Luminous Instant</p>
        ...
        <div id="concurso2">
            ...
            <a href="" class="">PARTICIPA</a>
            <img src="./img/participa.png" class="foto">
            <a href="" class="btn bases">BASES</a>
        </div>
        <div id="vota">
            <h1 class="titulos vota">SUBE TU #LUMINOUSSELFIE</h1>
            <img src="./img/foto-principal.png" class="photoPrincipal">
            <button class="like"></button>
            <button class="mayor"></button>
            <img src="./img/marco1.png" class="photo f1">
            <button class="like uno"></button>
            <button class="mayor one"></button>
            <img src="./img/marco1.png" class="photo f2">
            <button class="like dos"></button>
            <button class="mayor two"></button>
            <img src="./img/marco1.png" class="photo f3">
            <button class="like tres"></button>
            <button class="mayor three"></button>
            <img src="./img/marco1.png" class="photo f4">
            <button class="like cuatro"></button>
            <button class="mayor four"></button>
            <img src="./img/marco1.png" class="photo f5">
            <button class="like cinco"></button>
            <button class="mayor five"></button>
            <a href="" class="btn bases">BASES</a>
